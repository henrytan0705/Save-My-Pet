...
const PetGallery = ({
    ...
    const fetchPets = useCallback(async () => {
        try {
            ...
            if (debouncedSearchQuery) params.append('search', encodeURIComponent(debouncedSearchQuery));
            if (debouncedFilters.sort) params.append('sort', debouncedFilters.sort);
            if (debouncedFilters.animalType) params.append('animalType', debouncedFilters.animalType.toLowerCase());
            ...
            if (debouncedFilters.microchipped) params.append('microchipped', debouncedFilters.microchipped);
        ...
        return (
            ...
            >
                ...
                <div className={`absolute inset-0 py-2 px-4 flex flex-col justify-start ${isActive || isHovered ? 'opacity-80' : 'opacity-0'
                    ...
                    <p className="text-sm mb-1">
                        <span className="font-semibold">Gender:</span> {pet.gender || pet.sex} {/* Handle both gender and sex fields */}
                    </p>
                    <p className="text-sm mb-1">
        ...
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 ${className}`}>
            ...
            {!isPreview && (
                <div className="flex flex-wrap justify-center gap-3 mb-6">
                    ...
                    {Object.values(filters).some(val => val !== "" && val !== "recent") && (
                ...
                <div className="bg-gray-800 p-4 rounded-lg shadow-md mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 text-white">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="dog" className="text-white">Dog</option>
                            <option value="cat" className="text-white">Cat</option>
                            <option value="bird" className="text-white">Bird</option>
                    ...
                    <div>
                        <label className="block text-sm font-medium mb-1">Microchipped</label>
                        <select
                            className="select select-bordered w-full bg-gray-700 text-white"
                            value={filters.microchipped}
                            onChange={(e) => handleFilterChange('microchipped', e.target.value)}
                        >
                            <option value="" className="text-white">Any</option>
